...
Read .claude-plans/index.md  # Not found

# Create index and task directory
Write .claude-plans/index.md
Write .claude-plans/morning-exercise-research/plan.md
```
...
**.claude-plans/morning-exercise-research/plan.md:**
```markdown
...
```bash
Read .claude-plans/morning-exercise-research/plan.md   # Refresh goals
WebSearch "morning exercise benefits"
Write .claude-plans/morning-exercise-research/notes.md  # Store findings
Edit .claude-plans/morning-exercise-research/plan.md   # Mark Phase 2 complete
```
...
```bash
Read .claude-plans/morning-exercise-research/plan.md   # Refresh goals
Read .claude-plans/morning-exercise-research/notes.md  # Get findings
Write .claude-plans/morning-exercise-research/deliverable.md
Edit .claude-plans/morning-exercise-research/plan.md   # Mark Phase 3 complete
```

### Loop 4: Deliver

```bash
Read .claude-plans/morning-exercise-research/plan.md   # Verify complete
Edit .claude-plans/index.md                            # Move to completed
Deliver .claude-plans/morning-exercise-research/deliverable.md
```
...
### .claude-plans/fix-login-bug/plan.md
```markdown
# Task: Fix Login Bug
...
### .claude-plans/index.md (showing multiple tasks)
```markdown
# Task Index
...
### .claude-plans/dark-mode-toggle/plan.md
```markdown
...
### .claude-plans/dark-mode-toggle/notes.md
```markdown
...
# Update .claude-plans/[task]/plan.md:
## Errors Encountered
...
→ Read .claude-plans/[task]/plan.md    # This brings goals back into attention!
